...
\cventry
{Principal Data Scientist \tiny{-- Leverage advanced analytics to optimize supply chain of Walmart US}}          % Job title
...
\cventry
{Sr. Manager of Operations Research \tiny{-- Dedicated to development of integrated decision support system for railroads}}            % Job title
...
%---------------------------------------------------------
\cventry
{Software Engineer \tiny{-- Designed and Developed J2EE-based webapps}}                   % Job title
